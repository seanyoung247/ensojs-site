import{L as o,T as d,b as p,i as e,N as r,R as l,a as u,C as m}from"./reset-tpUweo2c.js";o.component("nav-btn",{watched:{open:r(!1),width:r(40),height:r(40)},styles:[e(l),e`
        :host {
            display: block;
            width: var(--w, 40px);
            height: var(--h, 40px);
    ...
    `,script:{onThemesChange:d(function(){this.applyTheme(this.watched.theme)},["themes"]),applyTheme(a){const s=this.watched.themes,n=s.some(t=>t.name===a)?a:s[0]?.name??null;n&&(this.watched.theme!==n&&(this.watched.theme=n),document.body.setAttribute("data-theme",n),localStorage.setItem("enso-theme",n),this.dispatchEvent(new CustomEvent("theme-changed",{detail:{theme:n}})))},onChange(a){this.refs.toggle.setAttribute("data-animate",!0),this.applyTheme(a)}}});const k=""+new URL("../theme_icons.svg",import.meta.url).href;o.component("enso-theme-switch",{template:p`
        <theme-switch .themes="[
        ...
        ></theme-switch>
    `});const y='.brush{position:relative;z-index:0}.brush:before{content:"";position:absolute;inset:0;background:var(--current-stroke);-webkit-mask-image:url('+new URL("../brush-stroke.svg",import.meta.url).href+");mask-image:url("+new URL("../brush-stroke.svg",import.meta.url).href+");-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-size:110% 250%;mask-size:110% 250%;-webkit-mask-position:right center;mask-position:right center;transform:scaleX(0);transform-origin:left;transition:transform .28s cubic-bezier(.25,.8,.25,1);z-index:-1}.brush.active:before,.brush.hover:hover:before{transform:scaleX(1)}",T=o.component("nav-section",{settings:{useShadow:!1},styles:[e(y),e`
        site-nav {
            position: fixed;
            z-index: 99;
            top: 0;
...
`;o.component("site-section",{styles:[e(l),e`
    ...
    `});o.component("tiny-counter",{watched:{value:r(0)},styles:e`:host{
        ...
        {{ @:value }}
        <button @click="()=>@:value++">+</button>
    `,script:{onChange:d(function(){const a=new CustomEvent("changed",{detail:this.watched.value});this.dispatchEvent(a)},["value"])}});const W=o.component("example-section",{settings:{useShadow:!1},styles:e`
        .body-text {
            text-align: center;
        }
    ...
    `}),B=o.component("why-enso",{settings:{useShadow:!1},styles:e`
        .why-enso-grid {
            width: 100%;
            list-style: none;
            display: grid;
