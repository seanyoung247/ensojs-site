import{L as o,T as d,a as p,i as e,N as r,R as l,_ as u,C as m}from"./reset-ctAW8ywF.js";o.component("nav-btn",{watched:{open:r(!1),width:r(40),height:r(40)},styles:[e(l),e`
        :host {
            display: block;
            width: var(--w, 40px);
            height: var(--h, 40px);
    ...
    `,script:{onThemesChange:d(function(){this.applyTheme(this.watched.theme)},["themes"]),applyTheme(a){const s=this.watched.themes,n=s.some(t=>t.name===a)?a:s[0]?.name??null;n&&(this.watched.theme!==n&&(this.watched.theme=n),document.body.setAttribute("data-theme",n),localStorage.setItem("enso-theme",n),this.dispatchEvent(new CustomEvent("theme-changed",{detail:{theme:n}})))},onChange(a){this.refs.toggle.setAttribute("data-animate",!0),this.applyTheme(a)}}});const k="/theme_icons.svg";o.component("enso-theme-switch",{template:p`
        <theme-switch .themes="[
        ...
        ></theme-switch>
    `});const y='.brush{position:relative;z-index:0}.brush:before{content:"";position:absolute;inset:0;background:var(--current-stroke);-webkit-mask-image:url(/brush-stroke.svg);mask-image:url(/brush-stroke.svg);-webkit-mask-repeat:no-repeat;mask-repeat:no-repeat;-webkit-mask-size:110% 250%;mask-size:110% 250%;-webkit-mask-position:right center;mask-position:right center;transform:scaleX(0);transform-origin:left;transition:transform .28s cubic-bezier(.25,.8,.25,1);z-index:-1}.brush.active:before,.brush.hover:hover:before{transform:scaleX(1)}',T=o.component("nav-section",{settings:{useShadow:!1},styles:[e(y),e`
        site-nav {
            position: fixed;
            z-index: 99;
            top: 0;
...
`;o.component("site-section",{styles:[e(l),e`
    ...
    `}),P=":root{--space-xs: clamp(.1rem, .25vw, .25rem);--space-sm: clamp(.25rem, .5vw, .5rem);--space-md: clamp(.5rem, 1vw, 1rem);--space-lg: clamp(1rem, 2vw, 2rem);--space-xl: clamp(2rem, 4vw, 3rem)}.constrained{--max-content: 1280px;width:100%}";o.component("enso-app",{settings:{useShadow:!1},styles:[e(_),e(P),e`
        enso-app {
            display: flex;
            flex-direction: column;
            align-items: center;
