const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/intro.enso-CO1KwQv5.js","assets/reset-CBHqupsG.js","assets/testpage2.enso-bzxFQFgb.js"])))=>i.map(i=>d[i]);
import{L as n,b as o,i as s,R as p,_ as r,T as f,C as g,a as d}from"./reset-CBHqupsG.js";const w=n.component("enso-404",{styles:[s(p),s`

    `],template:o`
        <h1>404</h1>
        <p>Page not found.</p>
    `});class y{#e;#i;#a;#t;constructor(t,e,i={}){this.#e=t,this.#i=e,this.#a=i.defaultPage??"intro",this.#t=i.base??"/"}normalize(t){return console.log(this.#t),this.#t!=="/"&&t.startsWith(this.#t)&&(t=t.slice(this.#t.length)),t}async navigate(t){const e=new URL(t,location.origin);history.pushState({},"",e.pathname),await this.load(e.pathname)}async load(t){t=this.normalize(t);const i=t.split("/").filter(Boolean).pop()||this.#a,l=this.#i[i],u=l?(await l()).default:w;this.#e.replaceChildren(u())}}function _(a,t="/docs"){navigation.addEventListener("navigate",e=>{if(!e.canIntercept)return;const i=new URL(e.destination.url);i.origin===location.origin&&i.pathname.startsWith(t)&&e.intercept({async handler(){await a.load(i.pathname)}})})}const h=[{title:"Test",children:[{id:"test-page-1",title:"Intro test",link:"test-page-1",loader:()=>r(()=>import("./intro.enso-CO1KwQv5.js"),__vite__mapDeps([0,1])),children:[{title:"dummy heading 1"}]}]},{title:"Test - 2",children:[{id:"test-page-2",title:"Test page 2",link:"test-page-2",loader:()=>r(()=>import("./testpage2.enso-bzxFQFgb.js"),__vite__mapDeps([2,1]))}]}];function m(a,t={}){for(const e of a)e.id&&e.loader&&(t[e.id]=e.loader),e.children&&m(e.children,t);return t}const v=m(h),c=new URL("docs/",location.origin+"/").pathname;n.component("enso-spa",{settings:{useShadow:!1},styles:s`
        enso-spa {
            display: flex;
            width: 100%;
            height: 100%;
